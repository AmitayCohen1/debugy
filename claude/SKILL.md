...
If the response includes a `notice` field, surface it to the user before continuing — it signals limits (e.g. monthly write quota exhausted) that affect what you can see.
